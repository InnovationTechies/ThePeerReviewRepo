...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="form-group">
            ...
            <asp:DropDownList ID="drpReviewee" runat="server" DataSourceID="objectEmployee" DataTextField="Name" DataValueField="Role" CssClass="form-control"></asp:DropDownList>
        ...
        <asp:ObjectDataSource ID="objectQuestions" runat="server" SelectMethod="GetQuestionsByEmployee" TypeName="PeerReviewSystem.Models.ReviewRepository">
            <SelectParameters>
                <asp:ControlParameter ControlID="drpReviewee" DefaultValue="" Name="Role" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
